...
const Johtaja: React.FC = () => (
  <Layout>
    ...
    <p className="block">
      ...
      kuoronjohdon A-kurssitutkintonsa erinomaisin arvosanoin. Kevätlukukaudella
      2017 hän syvensi opintojaan Itävallassa Universität für Musik und
      darstellende Kunst Wien -korkeakoulussa. Yrjölä on osallistunut useille
      Euroopan ammattikamarikuorojen verkoston Tenson järjestämille
      mestarikursseille työskennellen Cappella Amsterdamin, Helsingin
      kamarikuoron, Alankomaiden kamarikuoron, Slovenian Filharmonisen kuoron
      sekä Kroatian Radion ja television kuoron kanssa.
    </p>
